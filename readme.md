...
``` bash
composer require omaewa/moushindeiru
```
...
$this->crud->addField([
    ...
    'type' => 'new_field_name',
    'view_namespace' => 'omaewa.moushindeiru::fields',
]);
```
...
cp -i vendor/omaewa/moushindeiru/src/resources/views/fields/field_name.blade.php resources/views/vendor/backpack/crud/fields/field_name.blade.php
```
...
```bash
composer remove omaewa/moushindeiru
```

## Change log

Changes are documented here on Github. Please see the [Releases tab](https://github.com/omaewa/moushindeiru/releases).
...
[ico-version]: https://img.shields.io/packagist/v/omaewa/moushindeiru.svg?style=flat-square
[ico-downloads]: https://img.shields.io/packagist/dt/omaewa/moushindeiru.svg?style=flat-square

[link-packagist]: https://packagist.org/packages/omaewa/moushindeiru
[link-downloads]: https://packagist.org/packages/omaewa/moushindeiru
[link-author]: https://github.com/omaewa
